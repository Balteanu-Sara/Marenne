  ...
  return (
    <section className="flex flex-col gap-2 w-[100%] mt-[20px] font-garamond lg:gap-10">
      <div className="flex flex-col items-center text-center gap-0.5 lg:py-10">
        {book.subjects && (
          <p className="font-courier uppercase text-xs lg:text-sm">
            {book.subjects.join()}
          </p>
        )}
        <p className="text-4xl lg:text-5xl">{book.title}</p>
      </div>
        ...
        <div className="flex flex-col-reverse gap-2 lg:flex-row lg:w-3/4 lg: justify-between">
          ...
          <div className="content-center lg:w-2/3">
            <Image
              ...
              className="self-center w-[180px] h-[275px] border-1 border-black border-solid mx-auto lg:w-[295px] lg:h-[425px]"
            />{" "}
          </div>
        </div>
        <div className="border-t-black border-t-[1px] h-auto lg:w-1/4">
